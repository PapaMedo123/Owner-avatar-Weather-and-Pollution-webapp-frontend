...
class ApiClient {
  ApiClient({
    this.basePath = 'http://192.168.5.102:5039',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'ForecastDto':
          return ForecastDto.fromJson(value);
        case 'Measurement':
          return Measurement.fromJson(value);
        case 'MeasurementDto':
          return MeasurementDto.fromJson(value);
        case 'Station':
          return Station.fromJson(value);
        case 'StationDto':
          return StationDto.fromJson(value);
        default:
          dynamic match;
          if (value is List &&
